...
export default function MyNFTItem(props) {
  ...
  return (
    <Container>
      <Card
        hoverable
        style={{ width: 260, backgroundColor: '#343444', border: 'none' }}
      ...
      >
        <h3 className="text-white text-capitalize mb-0 text-center">
          {metadata?.center}
        </h3>
        <h4 className="text-white-50 text-center">{`NFT #${id}`}</h4>
      </Card>
    </Container>
  )
}
