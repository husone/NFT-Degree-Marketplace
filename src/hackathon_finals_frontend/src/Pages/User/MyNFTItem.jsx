  ...
  return (
    <Container>
      <Card
        ...
        cover={<img alt="example" src={metadata.cid} style={{ height: 250 }} />}
        // cover={
        //   <img
        //     alt="example"
        ...
        // }
      >
        <h4 className="text-white text-capitalize mb-0 text-center">
          {metadata?.center}
        </h4>
        <h5 className="text-white-50 text-center">{`NFT #${id}`}</h5>
      </Card>
    </Container>
  )
}
